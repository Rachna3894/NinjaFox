...
public class SalesActivity_Product3 extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_sale_product3);
        ...
        buttonPay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              String url="http://khulasa-news.com/ninjafox/razorpay/pay.php?planid=1&phone=898989898";
