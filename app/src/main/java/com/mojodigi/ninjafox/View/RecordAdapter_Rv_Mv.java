...
public class RecordAdapter_Rv_Mv extends ArrayAdapter<Record> {
    ...
    public RecordAdapter_Rv_Mv(Context context, int layoutResId, List<Record> list, int flag,adapterListener listener) {
...
popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
    ...
    public boolean onMenuItemClick(MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()) {
            case R.id.menu_new_atb:
                ...
                if(BrowserUtility.isUrlBlocked(context,prefs, record.getURL()))
                {
                    jmmToast.show(context, context.getString(R.string.blocked_url));
                    return false ;
                }

                listener.onNewTabSelectd(record);
    ...
    public interface adapterListener {
        void onNewTabSelectd(Record record);
